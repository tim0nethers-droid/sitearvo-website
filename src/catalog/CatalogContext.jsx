...
const normalizeService = (service, category) => ({
  ...
  regularPrice: (service.regularPrice ?? service.regular_price) === '' ? null : (service.regularPrice ?? service.regular_price ?? null),
  billingType: service.billingType || service.billing_type || (['monthly', 'yearly'].includes(service.priceType || service.price_type) ? String(service.priceType || service.price_type).toLowerCase() : 'one-time'),
  serviceType: service.serviceType || service.service_type || 'service',
  displayOrder: service.displayOrder ?? service.display_order ?? 0,
  ...
  addToCartEnabled: service.addToCartEnabled ?? service.add_to_cart_enabled ?? null,
  image: service.image || '',
