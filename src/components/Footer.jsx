...
export default function Footer() {
  ...
  return <footer className="footer">
    <div className="container footer-grid footer-services-grid">
      <div className="footer-brand"><Logo footer /><p>Modern websites designed to help businesses grow online.</p><div className="footer-contact"><AppIcon icon="map-pin" size={17} /> {company.location}</div><Link to="/services" className="text-link footer-view-all">View All Services</Link></div>
