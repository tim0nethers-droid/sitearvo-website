...
export default function Checkout() {
  ...
  return <>
    ...
    ].map(([name, label, type]) => name === 'country'
      ? <CountryField key={name} value={form[name]} onChange={event => setForm(current => ({ ...current, [name]: event.target.value }))} error={errors[name]} required />
