  ...
  return <>
    ...
    <section className="service-directory-tools">
      <div className="container">
        ...
        <label className="service-search"><Search aria-hidden="true" /><span className="sr-only">Search services</span><input type="search" value={query} onChange={event => setQuery(event.target.value)} placeholder="Search services..." /></label>
      </div>
    </section>
