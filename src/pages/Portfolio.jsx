import { Code2, LayoutTemplate, PenTool, ShoppingBag } from 'lucide-react';
...
const disciplines = [[LayoutTemplate, 'Web Design'], [Code2, 'React Development'], [ShoppingBag, 'E-commerce'], [PenTool, 'UI/UX']];
...
export default function Portfolio() {
  return <>
    ...
    <section className="portfolio-disciplines" aria-label="Portfolio capabilities"><div className="container">{disciplines.map(([Icon, label]) => <div key={label}><Icon aria-hidden="true" /><span>{label}</span></div>)}</div></section>
